 ...
 */
final class HotelsWithoutAmenitiesCollectionDataProvider extends AbstractCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    /**
     * @var RequestStack
     */
    ...
    public function supports(string $resourceClass, string $operationName = null, array $context = []): bool
    {
        return
            ...
            && $operationName === 'get_hotels_without_amenities';
    }
    ...
    protected function createQueryBuilder(string $resourceClass, string $operationName = null, array $context = [])
    {
        ...
        $baseQuery = $hotelRepository->getHotelsWithoutAmenitiesQuery('h', $searchQuery);
