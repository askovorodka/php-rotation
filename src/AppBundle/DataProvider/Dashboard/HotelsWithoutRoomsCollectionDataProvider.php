 ...
 */
final class HotelsWithoutRoomsCollectionDataProvider extends AbstractCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
    /**
     * @var RequestStack
     */
    ...
    public function supports(string $resourceClass, string $operationName = null, array $context = []): bool
    {
        return
            ...
            && $operationName === 'get_hotels_without_rooms';
    }
    ...
    protected function createQueryBuilder(string $resourceClass, string $operationName = null, array $context = [])
    {
        ...
        $baseQuery = $hotelRepository->getHotelsWithoutRoomsQuery('h', $searchQuery);
