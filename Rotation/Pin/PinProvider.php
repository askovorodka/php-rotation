...
class PinProvider implements PinProviderInterface
{
    ...
    public function getPins(int $cityId, int $regionId, int $presetId): PinCollection
    {
        ...
        $this->addLocalHotelPins($cityId, $regionId, $pinCollection);
     ...
     * @param PinCollection $pinCollection
     */
    private function addLocalHotelPins(int $cityId, int $regionId, PinCollection $pinCollection): void
    {
        $localHotelPins = $this->localHotelPinRepository->getActivePins($cityId, $regionId);
