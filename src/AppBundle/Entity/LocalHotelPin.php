 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\LocalHotelPinRepository")
 *
 * @ApiResource(
 *     attributes={
...
class LocalHotelPin
{
     ...
     * Set pinCategory.
     *
     * @param \AppBundle\Entity\PinCategory|null $pinCategory
     *
     * @return LocalHotelPin
     */
    public function setPinCategory(\AppBundle\Entity\PinCategory $pinCategory = null)
    {
     ...
     * Get pinCategory.
     *
     * @return \AppBundle\Entity\PinCategory|null
     */
