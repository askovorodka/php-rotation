 ...
 * @ApiResource(
 *     attributes={
 *         "normalization_context"={"groups"={"contact-category_GET"}},
 ...
 * @LoggableTableTitleAnnotation(title="Категории контактов")
 */
class ContactCategory
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Contact", mappedBy="contactCategory")
     */
    protected $contacts;
